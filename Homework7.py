...
## SI 206 - HW
## COMMENT WITH: Daniella Raz
## Your section day/time: Thursday Section with Niharika 8:30 AM
...
def get_tweets(search_term):
    if search_term in CACHE_DICTION:
        ...
        twitter_results = api.search(q = search_term)
...
for i in range(3):
    ...
    tweets_from_search = get_tweets(x)

    for tweet in tweets_from_search["statuses"]:
        print(tweet["text"])
